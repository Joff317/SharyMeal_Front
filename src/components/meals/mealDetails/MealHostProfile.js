        ...
        <div className="detail-host-container">
          ...
          <div className="right-detail-host-container">
            <div className="top-container">
              <span className="bio-title"><SubsectionTitle>Bio</SubsectionTitle></span>
              <p className="bio-container">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quis risus lectus nec, nunc. Elementum, tortor, facilisis sem in vel porttitor ultrices in facilisi. Sit blandit imperdiet egestas duis amet. Nulla dignissim nec nullam sed orci purus.</p>
            </div>
