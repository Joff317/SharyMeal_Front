...
function ToggleMap({setMapVisib, mapVisib}) {
    ...
    return (
        <div className="relative w-full px-52">
          ...
          >
          <input type="checkbox" value="" id="default-toggle" className="sr-only peer" onClick={handleToggle}/>
          ...
          <span className="ml-3 text-sm font-medium text-grey dark:text-grey">Map view</span>
        </label>
