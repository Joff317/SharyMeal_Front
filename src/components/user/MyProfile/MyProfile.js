        ...
        <div className='profile-container'>
            <div className='perso-infos-container'>
                ...
                >
                    ...
                    {
                        editConfirmVisib && 
                        <p className='bg-success text-white text-center p-1 rounded'>Profil correctement mis à jour.</p> 
                    }

                    {
                        editErrorVisib &&
                        <p className='bg-red text-white text-center p-1 rounded'>Une erreur est survenue.</p> 
                    }
