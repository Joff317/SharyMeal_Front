  ...
  return (
    <div className="condition-container">
      ...
      <p>
        ...
        Réserver une place dans un repas Trouver des repas autour de chez soit …
        ...
        identifié à l’aide de ses identifiants de connexion) : Créer une annonce
        de repas Réserver une place dans un repas Envoyer des messages … Le site
        et ses différents services peuvent être interrompus ou suspendus par
      ...
      <p>
        ...
        présents sur le site Shary Meal. Tout usage du service par l'Utilisateur
        ...
        membres de publier sur le site : Annonces de repas ; Message ; Etc. Le
        membre s’engage à tenir des propos respectueux des autres et de la loi
        et accepte que ces publications soient modérées ou refusées par
        l’Éditeur, sans obligation de justification. En publiant sur le site,
        l’Utilisateur cède à la société éditrice le droit non exclusif et
      ...
      <p>
        ...
        insurmontable d'un tiers. Le site SharyMeal s'engage à mettre en œuvre
      ...
      <p>
        ...
        SharyMeal pour la communication d’informations diverses et la gestion du
        compte. SharyMeal garantie le respect de la vie privée de l’utilisateur,
        conformément à la loi n°78-17 du 6 janvier 1978 relative à
        l'informatique, aux fichiers et aux libertés. En vertu des articles 39
        et 40 de la loi en date du 6 janvier 1978, l'Utilisateur dispose d'un
        droit d'accès, de rectification, de suppression et d'opposition de ses
        données personnelles. L'Utilisateur exerce ce droit via : Son espace
      ...
      <p>
        ...
        pas de contrôle sur ces liens. Il est possible pour un tiers de créer un
      ...
      <p>
        ...
        de France sont compétents pour régler le contentieux.
      </p>
    </div>
  );
};
